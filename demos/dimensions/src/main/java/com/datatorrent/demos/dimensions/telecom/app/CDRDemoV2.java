...
public class CDRDemoV2 implements StreamingApplication
{
  ...
  public void populateDAG(DAG dag, Configuration conf)
  {
    ...
    if (enableDimension) {
      // dimension
      dimensions = dag.addOperator("CDRDimensionsComputation", DimensionsComputationFlexibleSingleSchemaPOJO.class);
      ...
      List<DefaultInputPort<? super EnrichedCDR>> enrichedStreamSinks)
  {
    ...
    // store
    AppDataSingleSchemaDimensionStoreHDHT store = dag.addOperator("CDRGeoStore",
