...
public class DimensionsComputation<EVENT, AGGREGATE extends DimensionsComputation.AggregateEvent> implements Operator
{
  ...
  private AggregatorMap<EVENT, AGGREGATE>[] compositeAggregatorMaps;
   ...
   */
  public void setIncrementalAggregators(Aggregator<EVENT, AGGREGATE>[] incrementalAggregators)
  {
...
// bright: TODO: composite aggregator should need to implements aggregator interface.   
//    for (int i = compositeAggregators.length; i-- > 0; ) {
//      compositeAggregatorMaps[i] = new AggregatorMap<EVENT, AGGREGATE>(compositeAggregators[i]);
//    }
  }
